...
public class InfiniteWirelessTransmitterBlock extends NetworkNodeBlock {
    ...
    public InfiniteWirelessTransmitterBlock() {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new InfiniteWirelessTransmitterTile();
    }
    ...
    public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult hit) {
        return !world.isRemote ? NetworkUtils.attemptModify(world, pos, player, () -> {
            NetworkHooks.openGui((ServerPlayerEntity)player, new PositionalTileContainerProvider<InfiniteWirelessTransmitterTile>(new TranslationTextComponent("gui.rsinfinitewireless:infinite_wireless_transmitter"), (tile, windowId, inventory, p) -> {
                return new InfiniteWirelessTransmitterContainer(tile, player, windowId);
            }, pos), pos);
